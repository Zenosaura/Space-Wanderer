...
public class CharacterController2D : MonoBehaviour
{
	...
	private void Gravity()
	{
		...
		{
			m_Rigidbody2D.gravityScale = baseGravity * fallSpeedMultiplier; // fall faster
			m_Rigidbody2D.velocity = new Vector2(m_Rigidbody2D.velocity.x, Mathf.Max(m_Rigidbody2D.velocity.y - maxFallSpeed));
		}
		else
		{
	...
	{
		//Not grounded & on a wall & movement cant be 0
		if (!m_Grounded )
		{
